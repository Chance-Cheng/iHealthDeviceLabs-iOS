 ...
 * @param disposeQueryCurrentActiveInfo Total calories and steps for today, including parameters：Step、Calories.Step：Number of steps taken today.Calories：Number of calories burned today。
 * @param disposeErrorBlock see AM3S error descriptions
