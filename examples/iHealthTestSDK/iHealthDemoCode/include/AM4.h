...
#define AM4OutSwimmingTimeMark @"OutSwimmingTime"
...
typedef void (^DisposeAM4QueryCurrentActiveInfo)(NSDictionary *activeDictionary);//Total calories and steps for today, including parameters：Step、Calories
 ...
 * @param currentActiveInfo Total calories and steps for today, including parameters：Step、Calories.Step：Number of steps taken today.Calories：Number of calories burned today.
 * @param disposeErrorBlock see AM4 error descriptions
 */
