 ...
 * @param UnitName   The unit name string that BP7S show result should use,such as @"mmHg" or @"kPa".
 ...
 * @param angleInfo   A dictionary set the max and mini effective angles for left hand measurement and right hand measurement,the angle values type is NSNumber， with the four keys are: @"highAngleForLeft",@"lowAngleForLeft",@"highAngleForRight",@"lowAngleForRight".
